========================================================================
    ACTIVEX 控件 DLL : ActiveX 项目概述
========================================================================

控件向导已为 ActiveX ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 ActiveX ActiveX 控件 DLL 的每个文件的内容。
...
ActiveXCtrl.h
    此文件包含 CActiveXCtrl C++ 类的声明。

ActiveXCtrl.cpp
    此文件包含 CActiveXCtrl C++ 类的实现。

ActiveXPropPage.h
    此文件包含 CActiveXPropPage C++ 类的声明。

ActiveXPropPage.cpp
    此文件包含 CActiveXPropPage C++ 类的实现。

CActiveXCtrl.bmp
    此文件包含一个位图，当 CActiveXCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 ActiveX.pch 的预编译头 (PCH) 文件和名为 
