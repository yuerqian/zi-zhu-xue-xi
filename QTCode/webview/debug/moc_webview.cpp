...
QT_MOC_LITERAL(1, 8, 10), // "newtabView"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8), // "webview*"
QT_MOC_LITERAL(4, 29, 4) // "view"

    },
    "webview\0newtabView\0\0webview*\0view"
};
...
void webview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newtabView((*reinterpret_cast< webview*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (webview::*_t)(webview * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&webview::newtabView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void webview::newtabView(webview * _t1)
{
